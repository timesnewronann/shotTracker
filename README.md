...
6. [ High-Level Phases & Milestones](#high-level-phases--milestones)
7. [ Target MVP v0.1](#target-mvp-v01-end-of-week-2)
8. [ Tech Stack (initial)](#tech-stack-initial)
9. [ Repository Structure](#repository-structure)
   - [ Why This Repository Structure](#why-this-repository-structure)
10. [ Data Schema (JSONL for each session)](#data-schema-jsonl-for-each-session)
11. [ End-to-End Pipeline v0.1 (CLI)](#end-to-end-pipeline-v01-cli)
12. [ Algorithms (v0.1)](#algorithms-v01)
13. [ Testing Strategy](#testing-strategy)
14. [ Week-1 Plan (Hands-on)](#week-1-plan-hands-on)

- [ Why We Use uv](#why-we-use-uv)

15. [ Documentation Website (parallel, 30–60 min)](#documentation-website-parallel-30–60-min)
16. [ Issue Board (starter backlog)](#issue-board-starter-backlog)
17. [ Next Steps After Week-1](#next-steps-after-week-1)
18. [ Acceptance Criteria Templates](#acceptance-criteria-templates)
19. [ Notes](#notes)
